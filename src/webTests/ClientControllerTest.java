...
public class ClientControllerTest {
  ...
  public void ClientTest() throws IOException, SAXException {
    ...
    WebResponse resp1 = wc.getResponse("http://localhost:8080/edit_client");
    WebForm forms[] = resp1.getForms();
    forms[0].setParameter("name", "Test name");
    forms[0].setParameter("clientType", "person");
    resp1 = wc.getResponse(forms[0].getRequest(forms[0].getSubmitButton("save")));

    WebResponse resp2 = wc.getResponse("http://localhost:8080/clients");
    ...
    forms = resp2.getForms();
    assertEquals(forms[0].getAction(), "/edit_client");
    resp2 = wc.getResponse(forms[0].getRequest(forms[0].getSubmitButton("edit")));
    forms = resp2.getForms();
    assertEquals(forms[0].getAction(), "/save_client");
    ...
    forms = resp2.getForms();
    assertEquals(forms[1].getAction(), "/delete_client");
